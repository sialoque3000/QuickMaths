...
import com.example.quickmaths.entities.BaseEntity;
...
public abstract class BaseDao<T extends BaseEntity> {
    ...
    protected abstract String getScoreColumnName();
    ...
    public T getHighestScoreEntity() {
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        String scoreColumn = getScoreColumnName();
        String query = "SELECT * FROM " + getTableName() + " ORDER BY " + scoreColumn + " DESC LIMIT 1";
